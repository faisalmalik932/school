...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/plugins/confirmation/jquery-confirm.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/validationEngine.jquery.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/bootstrap-dropselect.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/common.css') }}">
    ...
    <script type="text/javascript" src="{{ asset('assets/js/core/libraries/jquery-1.12.4.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/plugins/confirmation/jquery-confirm.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/datatable/datatables.select.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/js/datatable/datatables.editor.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/saveupdate.js') }}"></script>
   ...
   <script type="text/javascript" src="{{ asset('assets//js/pages/components_modals.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('assets//js/plugins/buttons.flash.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets//js/plugins/buttons.html5.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets//js/plugins/buttons.print.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets//js/plugins/jszip.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets//js/plugins/pdfmake.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets//js/plugins/vfs_fonts.js')}}"></script>
    ...
    <!-- <script type="text/javascript" src="{{asset('assets/js/plugins/tables/datatables/datatables.cellEdit.js')}}"></script>
 -->
    <script type="text/javascript" src="{{asset('assets/bootstrap-datepicker/dist/js/bootstrap-datepicker.js')}}"></script>

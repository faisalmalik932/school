    ...
    <div class="panel-body">
        <div class="tabbable">
            <ul class="nav nav-tabs nav-tabs-bottom bottom-divided nav-justified">
                <li class="active"><a href="#form" data-toggle="tab">Salary Structure</a></li>
                <li><a href="#list" data-toggle="tab">Structure</a></li>
            </ul>
            <div class="tab-content" id="tabcontrol">
                <div class="tab-pane active" id="form">
                    <form method="POST" action="{{ url('/hr/settings/addsalarystructure') }}" id="DATAFORM" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="modal-content">
                            ...
                            <form action="#" method="GET">
                                <div class="modal-body">
                                    <div class="form-group formValidate">
                                        <div class="row">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <label>Amount</label>
                                                <input type="number" id="amount" maxlength="10" name="amount" class="form-control validate[required]" placeholder="Amount" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="dataform" class="btn btn-primary validateBtn">Add</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script  type="text/javascript" src="{{ asset('js/hr/salarystructure.js') }}"></script>
@endsection

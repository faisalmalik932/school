    ...
    <div class="panel-body">
        <div class="tabbable">
            <ul class="nav nav-tabs nav-tabs-bottom bottom-divided nav-justified">
                <li class="active"><a href="#form" data-toggle="tab">Add Income</a></li>
                <li><a href="#list" data-toggle="tab">Amounts</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="form">
                    <form method="POST" action="{{url('finance/transactions/add-income') }}" id="DATAFORM" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                ...
                <div class="tab-pane" id="list">
                    <table id="datatable" class="table" data-code="income"></table>
                </div>
            </div>
        </div>
    </div>

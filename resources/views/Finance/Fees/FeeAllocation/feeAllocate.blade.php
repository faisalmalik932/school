            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="form">
                        <form method="POST" action="{{ url('/finance/fees/allocate-fee') }}" name="myForm" id="DATAFORM"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Branch</label>
                                        <select id="branch" class="form-control DROPDOWN BRANCH  validate[required]" name="branch" data-dropdown="BRANCH">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Class</label>
                                        <select class="form-control CLASS select validate[required] SEED" id="class" name="class[]" multiple="multiple" data-seed="CLASSES">
                    ...
                    <div class="tab-pane" id="list">
                        <table id="datatable" class="table" data-code="feeallocation"></table>
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@section('jsheader')
    <script type="text/javascript" src="{{ asset('assets/js/fees/feeallocate.js') }}"></script>
@endsection
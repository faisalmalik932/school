        ...
        <form method="GET" action="" id="DATAFORM" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="row position-right" style="text-align: end; margin: 6px">
                    ...
                    <button type="reset" id="button" class="btn btn-primary"><i class="icon-floppy-disk position-left"></i> ExportPDF</button>
                </div>
            </div>
        </form>
...
<script type="text/javascript" src="{{ asset('assets/js/fees/feereport.js') }}"></script>

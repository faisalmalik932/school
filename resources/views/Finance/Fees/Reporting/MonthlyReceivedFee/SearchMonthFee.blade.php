...
@section('menu-head', 'Fees')
@section('title', 'Monthly Received Fee')
@section('content')
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <form method="GET"  action="{{ url('finance/fees/reports/branchmonthreceivedfeeReport') }}"  name="myForm" id="DATAFORM" enctype="multipart/form-data">

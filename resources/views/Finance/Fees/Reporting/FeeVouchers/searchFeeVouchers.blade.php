...
@section('title', 'Analysis Of Fee Vouchers')
@section('content')
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <form method="GET"  action="{{ url('finance/fees/reports/FeeVoucherReport') }}"  name="myForm" id="DATAFORM" enctype="multipart/form-data">

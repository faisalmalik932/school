...
@section('title', 'Branch Fee Defaulters')
@section('content')
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <form method="GET"  action="{{ url('finance/fees/reports/branchdefaultersreport') }}"  name="myForm" id="DATAFORM" enctype="multipart/form-data">

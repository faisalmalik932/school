<!DOCTYPE html>
<html>
    <title>Monthly Defaulters Fee Total</title>
    <style>
        .table {
...
<body>
<?php
$branch_name = $monthandBranch[0]->BRANCH_NAME;
$months = $monthandBranch[0]->MONTH;
$year = $monthandBranch[0]->YEAR;
?>
...
<h3 style="text-align: center"><b>Monthly Fee Defaulters Total</b></h3>
...
<div class="dataTable_wrapper TABLE">
    <table class="table" id="dataTables-example" align="center">
        ...
        <tr align="center" class="row">
            ...
            <th>Fee Category</th>
            <th>Fee Amount</th>
            <th>Defaulters Total Fee (Class)</th>
        </tr>
        </thead>
        <tbody>
        <?php $i=0; ?>

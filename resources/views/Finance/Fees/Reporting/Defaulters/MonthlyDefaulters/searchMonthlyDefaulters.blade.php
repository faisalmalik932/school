...
@section('title', 'Monthly Fee Defaulters')
@section('content')
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <form method="GET"  action="{{ url('finance/fees/reports/monthlydefaultersreport') }}"  name="myForm" id="DATAFORM" enctype="multipart/form-data">
            @include('Template.Components.messages')
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Select Branch </label>
                        <select class="form-control validate[required] DROPDOWN" data-dropdown="BRANCH" id="branch" name="branch">
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
